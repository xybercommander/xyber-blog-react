...
<ol>
  ...
  <li> Checkpoint 9 has the implementation of handling error messages. A new useState variable <code>const [error, setError] = useState(null)</code> is made for showing the messages</li>
</ol>
